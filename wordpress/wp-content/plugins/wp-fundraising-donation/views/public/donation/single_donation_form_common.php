...
$metaGeneralKey   = \WfpFundraising\Apps\Settings::OK_GENERAL_DATA;
...
$defaultNumberDecimal     = $defaultNumberDecimal < 0 ? 0 : $defaultNumberDecimal;

/*Custom class design data*/
$customClass  = ! empty( $getMetaData->form_design->custom_class ) ? $getMetaData->form_design->custom_class : '';
$customIdData = ! empty( $getMetaData->form_design->custom_id ) ? $getMetaData->form_design->custom_id : '';
