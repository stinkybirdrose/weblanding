						...
						'field_settings' => [
							...
							'description' => '<p>
										...
										4. Show Compare Button/Bar On Bottom<br/>
										 You need to upgrade to the <strong><a title="' . esc_html__("Upgrade Feature","shopengine") . '" href="https://wpmet.com/plugin/shopengine/pricing" target="_blank" style="color: red;">Premium</a> </strong> Version.</p>',
