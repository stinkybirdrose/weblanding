<div class="shopengine-archive-view-mode">
    <div class="shopengine-archive-view-mode-switch-list">
        ...
        <a title="<?php esc_html_e('Gird View','shopengine')?>" href="#" class="shopengine-archive-view-mode-switch isactive" data-view="grid">
        ...
        <a title="<?php esc_html_e('Gird 3 Columns View','shopengine')?>" href="#" class="shopengine-archive-view-mode-switch" data-view="grid-3">
        ...
        <a title="<?php esc_html_e('Gird 2 Columns View','shopengine')?>" href="#" class="shopengine-archive-view-mode-switch" data-view="grid-2">
        ...
        <a title="<?php esc_html_e('List View','shopengine')?>" href="#" class="shopengine-archive-view-mode-switch" data-view="list">
