	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'prefix_class' => 'elementors-align-',
				'selectors'    => [
					'{{WRAPPER}} .shopengine-product-rating .woocommerce-product-rating' => 'display: inline-block; margin: 0;',
					'.rtl {{WRAPPER}}.elementors-align-left .shopengine-product-rating' => 'text-align: right;',
					'.rtl {{WRAPPER}}.elementors-align-right .shopengine-product-rating' => 'text-align: left;',
					'.rtl {{WRAPPER}}.elementors-align-center .shopengine-product-rating' => 'text-align: center;',
				],
				'separator'    => 'before',
			]
		);
