<?php if (\Elementor\Plugin::$instance->editor->is_edit_mode() || is_preview()):
    ...
    if (!empty($page_type) && $page_type === 'single'): ?>
			<div class="woocommerce-message" role="alert">
				<a title="<?php esc_html_e('View Cart Item','shopengine')?>" href="#" tabindex="1" class="button wc-forward"><?php esc_html_e('View cart', 'shopengine')?></a><?php esc_html_e('“Beanie” has been added to your cart.', 'shopengine')?>
			</div>
		<?php else: ?>
