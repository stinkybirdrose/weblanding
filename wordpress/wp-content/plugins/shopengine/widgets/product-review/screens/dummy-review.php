		...
		<div id="review_form">
			<div id="respond" class="comment-respond">
				...
				<form action="#" method="post" id="commentform" class="comment-form" novalidate="">
					...
					<p class="stars">
						<span>
						<a title="<?php esc_html_e('One Star','shopengine')?>" class="star-1" href="#">1</a>
						<a title="<?php esc_html_e('Two Star','shopengine')?>" class="star-2" href="#">2</a>
						<a title="<?php esc_html_e('Three Star','shopengine')?>" class="star-3" href="#">3</a>
						<a title="<?php esc_html_e('Four Star','shopengine')?>" class="star-4" href="#">4</a>
						<a title="<?php esc_html_e('Five Star','shopengine')?>" class="star-5" href="#">5</a>
						</span>
					</p>
