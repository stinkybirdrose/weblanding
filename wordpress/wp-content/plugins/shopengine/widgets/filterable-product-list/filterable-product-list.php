                ...
                'fields_options' => [
                    ...
                    'width'     => [
                        ...
                        'selectors' 	=> [
                            ...
                            '.rtl {{WRAPPER}} .filter-nav li a:not(.active, :hover)' => 'border-width: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                            '.rtl {{WRAPPER}} .filter-nav li a.active, {{WRAPPER}} .filter-nav li a:hover' => 'border-width: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                        ],
                    ],
                    'color'     => [
