						...
						<div class="social-share">
							...
							foreach ( $share_buttons as $share_button ) {
								switch ( $share_button ) {
									case 'facebook':
										echo sprintf(
											'<a title="' . $share . '" href="%1$s" target="_blank" target="_blank"><i class="eicon-facebook"></i> <span>%2$s</span></a>',
									...
									case 'twitter':
										echo sprintf(
											'<a title="' . $twitter . '" href="%1$s" target="_blank" target="_blank"><i class="eicon-twitter"></i> <span>%2$s</span></a>',
									...
									case 'copy_url':
										echo sprintf(
											'<a title="' . $copy . '" href="#" class="copy-comparison-share-url" data-share-url="%1$s" data-message="%2$s"> <i class="eicon-copy"></i> <span>%3$s</span> </a>',
											$share_url,
